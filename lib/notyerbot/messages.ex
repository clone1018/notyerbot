defmodule Notyerbot.Messages do
  @moduledoc """
  ...
  def list_by_guild_and_channel(guild_id, channel_id) do
    Repo.all(
      from m in Message,
        where:
  ...
  def subscribe(guild_id, channel_id) do
    Phoenix.PubSub.subscribe(Notyerbot.PubSub, "#{guild_id}:#{channel_id}")
  end
